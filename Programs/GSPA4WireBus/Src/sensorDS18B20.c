...
int sensorDS18B20ParseData(int deviceNumber) {
    DS18B20[deviceNumber].raw.temperature = tempDataDS18B20[0] | tempDataDS18B20[1] << 8;
...
int sensorDS18B20GetTemperature() {
   ...
   rc = tempCalcCelciusDS18B20(&DS18B20[i]);
    drawTemperature(DS18B20[i].valueCelcius, i+1);   
    }      
   return rc;
}
